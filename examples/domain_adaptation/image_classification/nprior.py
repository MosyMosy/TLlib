...
def train(train_source_iter: ForeverDataIterator, train_target_iter: ForeverDataIterator, model: ImageClassifier,
    ...
    cl_loss = AverageMeter('cl_loss', ':6.2f')
    ce_loss = AverageMeter('ce_loss', ':6.2f')
    reg_loss = AverageMeter('reg_loss', ':6.2f')
    source_acc = AverageMeter('source_acc', ':3.1f')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ce_weight', default=1, type=float,
                        help='the weight hyper-parameter for class entropy loss')
    parser.add_argument('--reg_weight', default=1, type=float,
                        help='the weight hyper-parameter for regularization loss')
    # training parameters
