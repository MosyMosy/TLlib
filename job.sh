...
CUDA_VISIBLE_DEVICES=0 python nprior.py $SLURM_TMPDIR/TLlib_Dataset/office31 -d Office31 -s A -t W -a resnet50 --epochs 200 --seed 1 --log $SLURM_TMPDIR/TLlib/logs/nprior_20_111/Office31_A2W
